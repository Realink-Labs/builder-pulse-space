...
const translations = {
  en: {
    ...
    "hero.description":
      "Building RWA tokenization infrastructure that bridges traditional finance with Web3 through secure, compliant solutions.",
    ...
    "products.description":
      "From asset issuance to trading circulation, Realink Labs provides end-to-end RWA ecosystem, helping institutions and individuals securely and compliantly enter the Web3 world.",
    "products.coreTitle": "Core Products",
    "products.coreSubtitle": "Building Complete",
    "products.coreSubtitle2": "RWA Ecosystem",
    "products.coreDescription":
      "Five core products forming a complete RWA infrastructure matrix covering the full lifecycle of RWA.",
    "products.viewAll": "View All Products",

    // Product Names
    "product.realinkcloud.name": "RealinkCloud",
    "product.realinkcloud.subtitle":
      "One-stop RWA Issuance & Compliance Management Platform",
    "product.realinkcloud.description":
      "Asset issuance & registration, portfolio & risk control, KYC/AML compliance modules, API interface for institutional access",

    "product.realinkbridge.name": "RealinkBridge",
    "product.realinkbridge.subtitle": "Cross-chain Asset Channel",
    "product.realinkbridge.description":
      "Connecting mainstream public chains & layer 2 networks, supporting RWA & stablecoin interoperability, providing asset anchoring & clearing services",

    "product.realinkdid.name": "RealinkDID",
    "product.realinkdid.subtitle":
      "Decentralized Identity & Compliance Certification",
    "product.realinkdid.description":
      "On-chain decentralized identity (DID), scalable KYC/AML verification, unified identity across Realink ecosystem",

    "product.tangiblex.wallet.name": "TangibleX-Pay-Wallet",
    "product.tangiblex.wallet.subtitle":
      "Multi-chain Asset Wallet & Payment Tool",
    "product.tangiblex.wallet.description":
      "Supporting multi-chain RWA asset management, multi-sig & MPC security mechanisms, integrated on-chain payment & transfer functions",

    "product.tangiblex.market.name": "TangibleX-Market",
    "product.tangiblex.market.subtitle": "RWA Secondary Market",
    "product.tangiblex.market.description":
      "Providing on-chain trading & liquidity, P2P trading and institutional matching, integrated price oracles & market data",
    ...
    "about.description":
      "We're building infrastructure that connects real-world assets with blockchain technology, creating a secure, transparent, and compliant Web3 ecosystem bridge.",
    ...
    "feature.institutional.desc":
      "Enterprise security and compliance for large-scale operations.",
    "feature.userFriendly": "User Friendly",
    "feature.userFriendly.desc":
      "Intuitive interface design making Web3 onboarding simple and understandable.",
    "feature.globalReach": "Global Coverage",
    "feature.globalReach.desc":
      "Global compliance support for multi-jurisdictional business operations.",
    "feature.scalable": "Scalable",
    "feature.scalable.desc":
      "Infrastructure that grows with business needs, supporting enterprise scaling.",
    ...
    "coreFeatures.description":
      "Our comprehensive platform provides everything needed to tokenize, manage, and scale real-world assets in the digital economy.",
    "coreFeatures.compliance": "Compliance First",
    "coreFeatures.compliance.desc":
  ...
  zh: {
    ...
    "hero.description":
      "构建 RWA 代币化基础设施，通过安全合规的解决方案连接传统金融与 Web3。",
    ...
    "products.description":
      "从资产发行到交易流通，Realink Labs提供端到端的RWA生态系统，帮助机构和个人安全、合规地进入Web3世界。",
    "products.coreTitle": "核心产品",
    "products.coreSubtitle": "构建完整的",
    "products.coreSubtitle2": "RWA 生态系统",
    "products.coreDescription":
      "五大核心产品组成完整的RWA基础设施，从资产发行到交易流通，为您提供端到端的Web3金融解决方案。",
    ...
    "product.realinkcloud.description":
      "资产发行与登记、投资组合与风险控制、KYC/AML 合规模块、API 接口支持机构接入",

    "product.realinkbridge.name": "RealinkBridge",
    "product.realinkbridge.subtitle": "跨链资产通道",
    "product.realinkbridge.description":
      "连接主流公链与二层网络、支持 RWA 与稳定币互通、提供资产锚定与清算服务",

    "product.realinkdid.name": "RealinkDID",
    "product.realinkdid.subtitle": "去中心化身份与合规认证",
    "product.realinkdid.description":
      "链上去中心化身份 (DID)、可扩展的 KYC/AML 验证、跨 Realink 全生态统一身份",

    "product.tangiblex.wallet.name": "TangibleX-Pay-Wallet",
    "product.tangiblex.wallet.subtitle": "多链资产钱包与支付工具",
    "product.tangiblex.wallet.description":
      "支持多链 RWA 资产管理、多签 & MPC 安全机制、集成链上支付与转账功能",

    "product.tangiblex.market.name": "TangibleX-Market",
    "product.tangiblex.market.subtitle": "RWA 二级市场",
    "product.tangiblex.market.description":
      "提供链上交���与流动性、P2P 交易和机构撮合、集成价格预言机与市场数据",
    ...
    "about.title2": "与数字世界",
    "about.description":
      "我们正在构建连接现实世界资产与区块链技术的基础设施，创建一个安全、透明、合规的Web3生态系统桥梁。",
